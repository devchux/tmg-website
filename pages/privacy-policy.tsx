...
import styles from "styles/privacy-policy/privacy.module.scss";
    ...
    <div className={styles.privacy}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Triphecta Management Group, Lagos,
            Nigeria.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Triphecta Management Group,
            accessible from{" "}
            <a
              href="https://tmg-website-ivory.vercel.app/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://tmg-website-ivory.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://tmg-website-ivory.vercel.app/contact"
            rel="external nofollow noopener noreferrer"
            target="_blank"
          >
            https://tmg-website-ivory.vercel.app/contact
          </a>
        </li>
      </ul>
    </div>
